    ...
    return (
        <div className={`${classNameProp}  flex flex-column items-center justify-center gap-4 select-none`}>
            <div className='relative'>
                <div className={`transition-all hover:hover-menu-text menu-text cursor-pointer relative `} onClick={() => { setMenuOpen(!menuOpen) }}>
                ...
                <div className={`${menuOpen ? "block " : "hidden "} profile-card lg:w-[300px] w-[280px] h-auto top-10 right-1 absolute z-40 rounded-md flex flex-col gap-2 items-start py-4 `}>
                    {
                        notifyType.map((nt, i) =>(
